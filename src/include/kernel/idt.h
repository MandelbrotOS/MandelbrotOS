...
#define IDT_HANDLER(NAME, CODE)                                                \
  void NAME##_idt_handler(/* a better way? */                                  \
                          uint64_t _unused_rdi, uint64_t _unused_rsd,          \
                          uint64_t _unused_rdx, uint64_t _unused_rcx,          \
                          uint64_t _unused_r8, uint64_t _unused_r9,            \
                          uint64_t r15, uint64_t r14, uint64_t r13,            \
                          uint64_t r12, uint64_t r11, uint64_t r10,            \
                          uint64_t r9, uint64_t r8, uint64_t rpb,              \
